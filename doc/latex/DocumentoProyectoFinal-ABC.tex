...
también conocida como la \textsf{\textit{clase NP}}. \cite{Arora}
...
\begin{center}
Imagen 1.2 Diagrama de flujo del algoritmo que sigue la heurística
...
a lo que sería la abeja reina. \cite{Colonia}
...
\begin{center}
Imagen 2.1. La primera versión de Tetris, lanzado en 1984, corriendo
en un emulador de una computadora DVK-2 de la ex Unión Soviética.
\par\end{center}


\part*{3. Experimentación}

Se realizó experimentación buscando la semilla que contuviera la mayor
cantidad de ``Tetris'' dado una secuencia pseudoaleatoria de piezas
y la función de costo. 

Durante la experimentación se notó la necesidad de llevar el conteo
de la cantidad de epacios vacíos que se iban dejando en el transcurso
de un juego como un factor negativo. Como el objetivo era realizar
la mayor cantidad de Tetris en el juego, se consideró como principal
mantener una ``horizontalidad'' entre las piezas y una función que
...
obtuvo fue la semilla 5117 con la función generadora de numeros aleatorios
de MacOS y la semilla 915 con la función del sistema linux. 
...
Aunque la heurística ayude a encontrar soluciones inmediatas a ciertas
secuencias de piezas, el problema de ver ``hacia el futuro'' de
las piezas se mantiene y es básicamente imposible resolver con una
lista lo suficientemente grande. 

Convertir el problema a un problema ``off-line'' posiblemente incrementará
el número de tetris pero al ser un juego en el que eventualemnte perderás,
ambos problemas convergen al mismo punto por las mismas limitantes:
¿Qué me conviene al futuro después de n piezas? 


\part*{5. Documentación del código:}
